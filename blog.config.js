...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'df2993bf46d84098b634ed92e77bb983',
  ...
  GREETING_WORDS:
    ...
    'Hello, the largest Sugar Daddy dating site in New Zealand🐬, register now, start dating in New Zealand for free👩‍❤‍👨',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'THE LARGEST SUGAR DADDY DATING SITE IN NEW ZEALAND🐬', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.sugardaddymeet.com?tid=af100028782_bl5', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Sugar Daddy, Sugar Baby, sugardaddymeet, New Zealand', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/icon-other/icon/main/Singapore/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png

  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 6000, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://raw.githubusercontent.com/icon-other/icon/main/Singapore/logo.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
