...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hello, this is the biggest Sugar Daddy dating site in Canada🍁, register now, start dating for free👩‍❤‍👨',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'The largest sugar daddy dating site in Canada', // 作者简介
