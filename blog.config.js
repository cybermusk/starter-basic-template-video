...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hello, this is the largest Sugar Daddy dating site in New Zealand🐬, register now, start dating for free👩‍❤‍👨',
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/withAI777/stable_notion_template/main/public/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://github.com/icon-other/icon/blob/main/Singapore/logo.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
