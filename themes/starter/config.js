...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/America/test1.png', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/America/test1.png', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_TITLE_2: 'The best sugar daddy dating site for seeking secret arrangements in America. Join to meet local wealthy men and attractive women in your area! <a href="https://docs.tangly1024.com/article/start-to-write">We have over 8 million menbers</a>', // 英雄区文字
