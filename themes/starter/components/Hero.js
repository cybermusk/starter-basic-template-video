              ...
              >
                ...
                <li>
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-md bg-[#ff6666] px-7 py-[14px] text-center text-base font-medium text-white shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color"
                  >
                     {siteConfig('STARTER_HERO_BUTTON_1_TEXT', null, CONFIG)}
                  </a>
                </li>
