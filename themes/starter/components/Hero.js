        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4">
            ...
            >
              {/* 主标题 */}
              <h1
                className="mb-6 text-3xl font-bold leading-snug text-[#cda780] sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]"
              >
              ...
              >
                ...
                <li>
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-md bg-[#ff6666] px-7 py-[14px] text-center text-base font-medium text-white shadow-1 transition duration-300 ease-in-out hover:bg-[#cda780]"
                  >
                     {siteConfig('STARTER_HERO_BUTTON_1_TEXT', null, CONFIG)}
                  </a>
                </li>
