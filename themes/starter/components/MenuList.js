      ...
      <div>
        ...
        <nav
          ...
          <ul className='blcok lg:flex 2xl:ml-20'>
             <li>
              <a href="/signup" rel='nofollow' className='mx-8 flex py-2 text-base font-medium text-[#FF6666] group-hover:text-[#cda780] dark:text-[#FF6666] lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white'>JOIN NOW</a>
            </li>
            <li>
