      ...
      <div>
        ...
        <nav
          ...
          <ul className='blcok lg:flex 2xl:ml-20'>
             <li>
              <a href="/signup" rel='nofollow' className='ud-menu-scroll mx-8 flex py-2 text-base font-medium menu-color lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:hidden'>JOIN NOW</a>
            </li>
            <li>
