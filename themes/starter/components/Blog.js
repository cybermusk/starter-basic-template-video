...
export const Blog = ({ posts }) => {
  return (
    <>
      ...
      <section className='bg-white pb-8 pt-20 dark:bg-dark lg:pt-[50px]'>
                  ...
                  <div
                    ...
                    <div>
                      ...
                      <h3>
                        <Link
                          href={item?.href}
                          className='mb-4 inline-block text-xl font-semibold text-dark hover:text-[#cda780] dark:text-white dark:hover:text-[#cda780] sm:text-2xl lg:text-xl xl:text-2xl'>
                          {item.title}
                        </Link>
                      </h3>
