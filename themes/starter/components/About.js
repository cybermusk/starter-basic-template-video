      ...
      <div className="container">
        <div className="wow fadeInUp" data-wow-delay=".2s">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            {/* 左侧的文字说明板块 */}
            <div className="w-full px-4 lg:w-1/2 pb-8">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-md border bg-[#FF6666] px-7 py-3 text-center text-base font-medium text-white hover:bg-black"
                >
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                ...
                <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  <div
                    className="relative z-10 mb-4 flex items-center justify-center overflow-hidden bg-[#FFD700] px-6 py-12 sm:mb-8 sm:h-[160px] sm:p-5 lg:mb-4 xl:mb-8"
                  >
                    <div>
